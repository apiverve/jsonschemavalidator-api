# JSON Schema Validator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:jsonschemavalidator-api:1.1.12'
}
```
...
```java
import com.apiverve.jsonschemavalidator.JSONSchemaValidatorAPIClient;
import com.apiverve.jsonschemavalidator.APIResponse;
import com.apiverve.jsonschemavalidator.APIException;

// Initialize the client
JSONSchemaValidatorAPIClient client = new JSONSchemaValidatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/jsonschemavalidator](https://docs.apiverve.com/ref/jsonschemavalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/jsonschemavalidator](https://docs.apiverve.com/ref/jsonschemavalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/jsonschemavalidator-api/issues)
