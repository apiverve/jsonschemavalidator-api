...
{
    class JSONSchemaValidatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/jsonschemavalidator";

        /// <summary>
        /// Make a POST request to the JSON Schema Validator API
        /// </summary>
        static async Task<JsonDocument> CallJSONSchemaValidatorAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { schema &#x3D; [object Object], json &#x3D; [object Object] };
        ...
        {
            Console.WriteLine("📤 Calling JSON Schema Validator API...\n");

            var result = await CallJSONSchemaValidatorAPI();
