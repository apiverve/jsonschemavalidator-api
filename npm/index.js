...
class jsonschemavalidatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/jsonschemavalidator');
        }
        ...
        this.validationRules = {"schema":{"type":"object","required":true},"json":{"type":"object","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/jsonschemavalidator`);
        }
    }
...
module.exports = jsonschemavalidatorWrapper;
