...
namespace APIVerve.API.JSONSchemaValidator
{
    ...
    /// <summary>
    /// Client for the JSONSchemaValidator API
    /// </summary>
    public class JSONSchemaValidatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/jsonschemavalidator";
        ...
        {
            { "schema", new ValidationRule { Type = "object", Required = true } },
        ...
        public JSONSchemaValidatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JSONSchemaValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JSONSchemaValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, JSONSchemaValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(JSONSchemaValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(JSONSchemaValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(JSONSchemaValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(JSONSchemaValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(JSONSchemaValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(JSONSchemaValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(JSONSchemaValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(JSONSchemaValidatorQueryOptions options)
        {
