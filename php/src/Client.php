...
namespace APIVerve\Jsonschemavalidator;
...
/**
 * Client for the JSON Schema Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/jsonschemavalidator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/jsonschemavalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\JsonschemavalidatorClient] {$message}\n";
        }
    }
}
