...
class TestJsonschemavalidatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = JsonschemavalidatorAPIClient(self.api_key)

    @patch('apiverve_jsonschemavalidator.apiClient.requests.get')
